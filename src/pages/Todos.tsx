...
export function Todos() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    console.log('[Todos] Auth user before write:', auth.currentUser?.uid);
    console.log('[Todos] ENV check — project:', import.meta.env.VITE_FIREBASE_PROJECT_ID);
    ...
    try {
      ...
      clearTimeout(timeout);
      console.error('[Todos] Failed to add todo:', err);
